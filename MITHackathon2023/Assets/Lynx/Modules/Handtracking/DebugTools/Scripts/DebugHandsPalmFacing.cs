...
public class DebugHandsPalmFacing : MonoBehaviour
{
    ...
    private void UpdateDebugLines()
    {
        if (debugHandRight)
        {
            UpdateDebugLineHand(Hands.Right, ref debugLinePalmNormalRight/*, ref debugLinePalmToEyeRight*/);
        }
        if (debugHandLeft)
        {
            UpdateDebugLineHand(Hands.Left, ref debugLinePalmNormalLeft/*, ref debugLinePalmToEyeLeft*/);
        }
    }
